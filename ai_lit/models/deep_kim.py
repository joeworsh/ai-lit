"""
Deep CNN implementation for document classification based on the CNN Kim,
but with additional deep layers.
"""

import tensorflow as tf

tf.flags.DEFINE_integer("num_layers", 3,
                        "The number of layers in this model. Based on this number, uses hN_filter configurations.")
tf.flags.DEFINE_string("h1_filters", "3,4,5,6",
                       "String containing a comma-separated list of convolutional filter sizes for the CNN")
tf.flags.DEFINE_string("h2_filters", "3,4,5,6",
                       "String containing a comma-separated list of convolutional filter sizes for the CNN")
tf.flags.DEFINE_string("h3_filters", "3,4,5,6",
                       "String containing a comma-separated list of convolutional filter sizes for the CNN")
tf.flags.DEFINE_string("h4_filters", "3,4,5,6",
                       "String containing a comma-separated list of convolutional filter sizes for the CNN")
tf.flags.DEFINE_string("h5_filters", "3,4,5,6",
                       "String containing a comma-separated list of convolutional filter sizes for the CNN")
tf.flags.DEFINE_string("h6_filters", "3,4,5,6",
                       "String containing a comma-separated list of convolutional filter sizes for the CNN")
tf.flags.DEFINE_string("h7_filters", "3,4,5,6",
                       "String containing a comma-separated list of convolutional filter sizes for the CNN")
tf.flags.DEFINE_string("h8_filters", "3,4,5,6",
                       "String containing a comma-separated list of convolutional filter sizes for the CNN")
tf.flags.DEFINE_string("h9_filters", "3,4,5,6",
                       "String containing a comma-separated list of convolutional filter sizes for the CNN")
tf.flags.DEFINE_string("h10_filters", "3,4,5,6",
                       "String containing a comma-separated list of convolutional filter sizes for the CNN")

tf.flags.DEFINE_integer("h1_num_filters", 128,
                        "The total number of filters for each filter size in the graph.")
tf.flags.DEFINE_integer("h2_num_filters", 128,
                        "The total number of filters for each filter size in the graph.")
tf.flags.DEFINE_integer("h3_num_filters", 128,
                        "The total number of filters for each filter size in the graph.")
tf.flags.DEFINE_integer("h4_num_filters", 128,
                        "The total number of filters for each filter size in the graph.")
tf.flags.DEFINE_integer("h5_num_filters", 128,
                        "The total number of filters for each filter size in the graph.")
tf.flags.DEFINE_integer("h6_num_filters", 128,
                        "The total number of filters for each filter size in the graph.")
tf.flags.DEFINE_integer("h7_num_filters", 128,
                        "The total number of filters for each filter size in the graph.")
tf.flags.DEFINE_integer("h8_num_filters", 128,
                        "The total number of filters for each filter size in the graph.")
tf.flags.DEFINE_integer("h9_num_filters", 128,
                        "The total number of filters for each filter size in the graph.")
tf.flags.DEFINE_integer("h10_num_filters", 128,
                        "The total number of filters for each filter size in the graph.")
